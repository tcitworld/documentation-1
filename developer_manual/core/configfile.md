...
Nextcloud can be set to use a custom app directory in
/config/config.php. Customise the following code and add it to your
config file:
...
Nextcloud will use the first app directory which it finds in the array
with 'writable' set to true.
